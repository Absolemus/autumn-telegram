...
Перем ХранителиСобытий; // Массив хранителей событиеов
Перем События; // таблица, в которой будут храниться события
Перем Параметры; // таблица, в которой будут храниться параметры
